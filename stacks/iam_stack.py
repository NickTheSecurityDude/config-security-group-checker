...
class IAMStack(core.Stack):
  ...
  def __init__(self, scope: core.Construct, construct_id: str, proj, env, **kwargs) -> None:
    ...
    self._config_sg_open_lambda_role=iam.Role(self,"Security Group IAM Lambda Role",
  ...
  # Exports
  @property
  def config_sg_open_lambda_role(self) -> iam.IRole:
    return self._config_sg_open_lambda_role